  ...
  return (
    <div className="fixed top-4 left-4 z-50 select-none">
      <motion.button
        ...
        whileTap={{ scale: 0.92 }}
        onClick={toggleMute}
        className="flex items-center gap-2 px-3.5 py-1.5 bg-[#FAF6DE]/90 backdrop-blur-md rounded-full shadow-[0_4px_14px_rgba(75,50,120,0.18)] border border-[#C4B4E3] text-[#715AC3] cursor-pointer transition-all hover:bg-white"
        title={isMuted ? "Unmute music" : "Mute music (60% volume)"}
      >
        {/* Animated Music Note / Disc */}
        <div className="relative w-5 h-5 flex items-center justify-center">
          {isMuted ? (
            <span className="text-sm text-[#98263A]">🔇</span>
          ) : (
            <motion.span 
        ...
        <div className="flex items-center gap-1.5 font-serif-vintage text-xs font-semibold tracking-wide">
